 ...
 *
 */
public final class AndPredicate implements StreamPredicate, CompoundPredicate {
    ...
    public AndPredicate(StreamPredicate... predicates) {
    ...
    public void setPredicates(StreamPredicate[] predicates) {
        ...
        if (Objects.isNull(this.predicates)) {
            ...
            throw new IllegalStateException(
                "Cannot reset predicates in an AndPredicate after they have been already set");
        }
    }
